// AUTO-GENERATED from the live Supabase schema (supabase gen types typescript).
// Do not edit by hand. Regenerate after migrations. Hand-authored domain
// models live in types.ts; this is the generated source of truth.
...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      bookings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bookings_promo_code_fk"
      ...
      fraud_flags: {
        Row: {
          ...
          reason: Database["public"]["Enums"]["fraud_flag_reason"]
          resolved: boolean
          user_id: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "fraud_flags_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "fraud_flags_payment_id_fkey"
            columns: ["payment_id"]
            isOneToOne: false
      ...
      loyalty_balances: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "loyalty_balances_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      owns_business: {
        Args: { p_business_id: string; uid?: string }
        Returns: boolean
      }
    ...
    Enums: {
      ...
      notification_type:
        ...
        | "promo"
        | "system"
      payment_method: "card" | "wallet" | "local_gateway" | "cash"
      payment_status:
        | "unpaid"
        | "authorized"
        | "paid"
      ...
      user_role: "customer" | "business_owner" | "staff" | "admin"
      verification_status:
        | "pending"
        | "in_review"
        | "verified"
